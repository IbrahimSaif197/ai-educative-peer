...
| 41 | **Reflection offer after a clean scan** | Fix every flagged issue in the block you are working on and wait for the rescan. A notification asks "this block scans clean now. Want a quick reflection quiz on the fix?" with "Quiz me" / "Not now". |
